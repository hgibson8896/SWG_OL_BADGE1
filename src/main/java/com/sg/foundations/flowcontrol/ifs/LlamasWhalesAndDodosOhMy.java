...
public class LlamasWhalesAndDodosOhMy {
    ...
    public static void main(String[] args) {
        ...
        if(dodos == 0){
            ...
            System.out.println("Edgads, I thought dodos were extinct!");
        ...
        if(llamas <= whales){
            System.out.println("Aw man, brawn over brains. Whales beat llamas.");
        }
        
        
        System.out.println("Theres been a hige increase in the dodo popultation via cloning!");
        dodos += 100;
